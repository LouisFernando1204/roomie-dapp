                        ...
                        <div className="mb-12 lg:mb-0 lg:grid lg:grid-cols-2 lg:gap-8 xl:gap-16">
                            ...
                            <div className="mt-4 lg:mt-0">
                                ...
                                <button
                                    ...
                                    type="button" className="w-full mt-4 text-white bg-primary hover:bg-darkYellow focus:outline-none focus:ring-gray-100 font-medium rounded-lg text-base px-4 py-2 text-center inline-flex justify-center items-center">
