...
import { createUserCase, createAccommodationCase } from "../../server/case";
                        ...
                        <form className="p-4 md:p-5">
                            <div className="mb-4 grid grid-cols-2 gap-4">
                                ...
                                <div className="col-span-2">
                                    ...
                                    <div className="flex w-full items-center justify-center">
                                        <label htmlFor="caseEvidence" className="flex h-96 w-full cursor-pointer flex-col items-center justify-center rounded-lg border-2 border-dashed border-gray-300 bg-gray-50 hover:bg-gray-100">
                                            {caseEvidence ? (
                                                <img src={caseEvidence} alt="Preview" className="h-full w-full object-cover rounded-lg" />
                                            ) : (
                            ...
                            <div className="border-t border-gray-200 pt-4 md:pt-5">
                                ...
                                <button
                                    ...
                                    type="button"
                                    className="me-2 rounded-lg border border-gray-200 bg-white px-5 py-2.5 text-sm font-medium text-gray-900 hover:bg-gray-100 hover:text-primary-700 focus:z-10 focus:outline-none">Cancel</button>
                            </div>
                        </form>
                    </div>
                </div>
